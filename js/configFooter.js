...
<footer class="bg-surface-container-lowest text-tertiary font-body-md text-body-md mt-auto border-t border-outline-20">
  <div class="flex flex-col md:flex-row flex-wrap justify-between items-start px-5 md:px-12 py-8 max-w-7xl mx-auto gap-8">
    ...
    <div class="flex flex-col mb-4 md:mb-0 w-full md:w-auto">
      ...
      <div class="text-sm text-secondary">Â© 2026 ${datosEstablecimiento.nombre}. Todos los Derechos Reservados.</div>
    </div>

    <!-- Columna 2: PQR y AtenciÃ³n -->
    <div class="flex flex-col w-full md:w-auto text-sm">
      <h4 class="font-bold text-primary mb-3">AtenciÃ³n al Cliente</h4>
      ...
      <span class="text-xs text-secondary mt-1">Respuesta PQR: mÃ¡x. 15 dÃ­as hÃ¡biles</span>
    </div>

    <!-- Columna 3: Legal -->
    <div class="flex flex-col w-full md:w-auto text-sm">
      <h4 class="font-bold text-primary mb-3">InformaciÃ³n Legal</h4>
      <a href="terminos.html" class="hover:text-primary transition-colors mb-2">TÃ©rminos y Condiciones</a>
      <a href="privacidad.html" class="hover:text-primary transition-colors mb-2">PolÃ­tica de Privacidad</a>
  ...
  <div class="border-t border-outline-20 py-4 text-center text-xs text-secondary px-5">
